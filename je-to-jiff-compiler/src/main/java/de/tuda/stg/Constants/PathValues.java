...
public class PathValues {
    ...
    public static String JE_FOLDER_PATH = "test-cases/src/main/je/de/tuda/stg/TestPoint/";
    public static String GENERATED_JIF_FOLDER_PREFIX = "test-cases/src/main/generated-jif/de/tuda/stg/TestPoint/";
