                ...
                for (File file : directoryListing) {
                    ...
                    if (FilenameUtils.getExtension(file.getPath()).equals("java")) {  //Change this later
                        ...
                        if (ParserHelper.isClassAnnotatedWithEnclaveAnnotation(cu)) {
                            ...
                            FileUtils.writeStringToFile(GENERATED_JIF_FOLDER_PATH +currentFileBaseName+".jif", jifCodeAddedString);
                        }
                    } else {
                ...
                for (File file : directoryListing) {
                    ...
                    if (FilenameUtils.getExtension(file.getPath()).equals("java")) {  //Change this later
                        ...
                        if (ParserHelper.isClassAnnotatedWithEnclaveAnnotation(cu)) {
                            ...
                            FileUtils.writeStringToFile(GENERATED_JAVA_FOLDER_PATH +currentFileBaseName+".java", enclaveJavaCodeWithCommNoJEAnnoString);
