...
public class PathValues {
    ...
    public static final String GENERATED_JAVA_PACKAGE_NAME = "compiled";

    public static String JE_FOLDER_PATH = "test-cases/src/main/je/de/tuda/prg/TestPoint/";

    public static String GENERATED_JIF_FOLDER_PREFIX = "test-cases/src/main/generated-jif/de/tuda/prg/TestPoint/";

    public static String GENERATED_JAVA_FOLDER_PREFIX = "test-cases/src/main/generatedjava/de/tuda/prg/TestPoint/";
