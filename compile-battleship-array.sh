...
export JIF_PATH="./test-cases/src/main/manual-jif-files/battleship-array/"
export JAVA_GENERATED_PATH="./test-cases/src/main/generatedjava/de/tuda/prg/battleship-array/"
...
# eval "${JIFC_BIN}jifc" -robust -nooutput -classpath ${JIFC_PRINCIPALS} ${JIF_PATH}/GuessAndResult.jif ${JIF_PATH}/GridPlayer1.jif ${JIF_PATH}/GridPlayer2.jif
eval "${JIFC_BIN}jifc" -robust -explain -nooutput -classpath ${JIFC_PRINCIPALS} ${JIF_PATH}/GuessAndResult.jif ${JIF_PATH}/GridPlayer1.jif