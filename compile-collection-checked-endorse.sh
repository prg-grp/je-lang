...
# export JE_PATH="./test-cases/src/main/je/de/tuda/prg/collection/"
export JIF_PATH="./test-cases/src/main/manual-jif-files/checked-endorsement-collection"
# export JAVA_GENERATED_PATH="./test-cases/src/main/generatedjava/de/tuda/prg/collection/"
...
eval "${JIFC_BIN}jifc" -robust -nooutput -classpath ${JIFC_PRINCIPALS} ${JIF_PATH}/TaskProcessor_Checked_endorse.jif