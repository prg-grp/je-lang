...
JE_PATH="./test-cases/src/main/je/de/tuda/stg/encryptor"
JIF_PATH="./test-cases/src/main/generated-jif/de/tuda/stg/encryptor"
JAVA_GENERATED_PATH="./test-cases/src/main/generatedJava/de/tuda/stg/encryptor"
...
eval "${JIFC_PATH}jifc" -classpath ${JIFC_PRINCIPLES_PATH} ${JIF_PATH}/*.jif
